                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            <% if (it.coberturaAction.result != null) { %>
                                                                                                                                                                                                                                                <% def cr = it.coberturaAction.result %>
                                                                                                                                                                                                                                                    <div class="coverage round_border">
                                                                                                                                                                                                                                                        <table>
                                                                                                                                                                                                                                                            <TR><TD class="bg1"><B>Gcovr Coverage report:</B></TD></TR>
                                                                                                                                                                                                                                                                <% cr.metrics.each { m -> %>
                                                                                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                                                                                        <TD colspan="2" class="bg2"><B>${m.name}:</B></TD>
                                                                                                                                                                                                                                                                            <td colspan="2" class="bg2">${cr.getCoverage(m).percentage}% (${cr.getCoverage(m)})</td>
                                                                                                                                                                                                                                                                                </tr>
                                                                                                                                                                                                                                                                                    <% } %>
                                                                                                                                                                                                                                                                                        </table>
                                                                                                                                                                                                                                                                                            <a href="${rooturl}${build.url}cobertura">coverage file level detail</a>            
                                                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                                                <% } %>
                                                                                                                                                                                                                                                                                                <% } %>
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <%  build.getLog(100).each() { line -> %>
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    </BODY>''', subject: 'build complete', to: 'xinjiayang@deepglint.com'
	    }
	}
	stage('End') {
	    steps {
